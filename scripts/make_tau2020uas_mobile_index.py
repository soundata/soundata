...
INDEX_PATH = "../soundata/datasets/indexes/tau2020uas_mobile_index.json"
...
if __name__ == "__main__":
    PARSER = argparse.ArgumentParser(
        description="Generate tau2020uas_mobile index file."
    )
    PARSER.add_argument(
        "data_path", type=str, help="Path to tau2020uas_mobile data folder."
    )
