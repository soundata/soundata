...
For more information, see :ref:`Using soundata with tensorflow`.
...
----------------------
soundata = mir + data. MIR is an acronym for Music Information Retrieval, and the library was built for working with data.
